...
$(document).ready(function () {
    ...
    $('iframe#game').load(function () {
        ...
        sound = $('iframe#game').contents().find('a#sound');
...
function loadLevel(level_name) {
    ...
    setTimeout(function () {
        ...
        $('iframe#game').load(function () {
            ...
            if (persona == 'lord') {
                $('iframe#game').contents().find('section#blue').remove()
            } else {
                $('iframe#game').contents().find('section#lord').remove()
            }
...
function setupNavBar() {
    ...
    if (level > 0 && level_title != '') {
        navbar_title.html("Project Euler: <span>" + level_title + "</span>");
    ...
    if (level == 0) {
        $('iframe#game').contents().find('section#navbar h2').html("Project Euler");
    }
